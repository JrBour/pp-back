 ...
 */
final class Version20200402143034 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE albums (id INT NOT NULL, event_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_F4E2474F71F7E88B ON albums (event_id)');
        $this->addSql('CREATE TABLE events (id INT NOT NULL, author_id INT DEFAULT NULL, name VARCHAR(90) NOT NULL, description VARCHAR(255) NOT NULL, image VARCHAR(125) DEFAULT NULL, address VARCHAR(255) NOT NULL, city VARCHAR(125) NOT NULL, zipcode INT NOT NULL, start_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, end_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, share_fees BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_5387574AF675F31B ON events (author_id)');
        $this->addSql('CREATE TABLE users (id INT NOT NULL, given_name VARCHAR(125) NOT NULL, last_name VARCHAR(125) NOT NULL, phone VARCHAR(254) NOT NULL, email VARCHAR(254) NOT NULL, image VARCHAR(125) DEFAULT NULL, password VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE medias ADD CONSTRAINT FK_12D2AF811137ABCF FOREIGN KEY (album_id) REFERENCES albums (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE albums ADD CONSTRAINT FK_F4E2474F71F7E88B FOREIGN KEY (event_id) REFERENCES events (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE albums DROP CONSTRAINT FK_F4E2474F71F7E88B');
