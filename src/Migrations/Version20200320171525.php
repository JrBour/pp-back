 ...
 */
final class Version20200320171525 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT NOT NULL, given_name VARCHAR(125) NOT NULL, last_name VARCHAR(125) NOT NULL, email VARCHAR(254) NOT NULL, image VARCHAR(125) DEFAULT NULL, password VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
